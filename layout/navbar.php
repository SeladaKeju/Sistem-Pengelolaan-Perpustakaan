<div class="sidebar-wrapper active">
    ...
    <div class="sidebar-menu">
        <ul class="menu">
            ...
            <li class="sidebar-item" id="members">
            ...
            <li class="sidebar-item" id="books">
            ...
            <li class="sidebar-item" id="loans">
                <a href="index.php?page=loans" class='sidebar-link'>
...
<script>
    ...
    menuItems.forEach(item => {
        const link = item.querySelector('a'); // Ambil link di dalam item
